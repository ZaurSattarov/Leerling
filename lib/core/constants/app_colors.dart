...
class AppColors {
  ...
  static const Color primaryDark = Color(0xFFA8243E);
  static const Color accent = Color(0xFFFFE9D7);
  ...
  static const Color border = Color(0xFFE9EBF0);
  ...
  static const Color dangerBorder = Color(0xFFFFE4E6);
