...
- **Authentication Flow Orchestration** — app_routerprovider, app_authnotifier, student_service_studentservice, auth_design_authdesign [INFERRED 0.80]
- **Ported-from-Instructeur-App Design Parity** — app_colors_appcolors, nav_shell_tokens_navshelltokens, external_instructeur_app_nav_shell_tokens, lespakket_detail_lespakketdetail [INFERRED 0.75]
- **MainDetailHeader + AppCard List Screen Pattern** — examenadvies_screen_ExamenadviesScreen, examens_screen_ExamensScreen, lesvoorbereiding_screen_LesvoorbereidingScreen, help_screen_HelpScreen [INFERRED 0.85]
- **Home Dashboard Data Aggregation** — home_screen_HomeScreen, home_provider_homeProvider, home_coach_provider_homeCoachProvider, lesvoorbereiding_provider_lesvoorbereidingProvider [EXTRACTED 1.00]
- **Examen Readiness Scoring Flow** — examenadvies_calculator_ExamenadviesCalculator, examenadvies_data_ExamenadviesData, examenadvies_provider_examenadviesProvider, home_coach_provider_homeCoachProvider [EXTRACTED 1.00]
- **Profiel menu navigation flow** — profiel_screen_ProfielHub, persoonlijke_gegevens_screen_ProfielPersoonlijkeGegevensScreen, mijn_rijschool_screen_MijnRijschoolScreen, lespakket_detail_screen_ProfielLespakketScreen, app_instellingen_screen_AppInstellingenScreen [INFERRED 0.85]
- **App-instellingen settings navigation flow** — app_instellingen_screen_AppInstellingenScreen, notificatie_instellingen_screen_NotificatieInstellingenScreen, app_machtigingen_screen_AppMachtigingenScreen, beveiliging_screen_BeveiligingScreen [INFERRED 0.85]
- **Lesson planning-to-detail-to-evaluation flow** — planning_screen_PlanningScreen, planning_provider_lesDetailProvider, les_detail_screen_LesDetailScreen, les_detail_screen_EvaluatieSection, lesson_status_badge_LessonStatusBadge [INFERRED 0.80]
- **Voortgang tab data pipeline (profiel + lespakket + trends feed the screen)** — auth_provider_mijnProfielProvider, lespakket_voortgang_provider_lespakketVoortgangProvider, voortgang_trends_provider_voortgangTrendsProvider, voortgang_screen_VoortgangScreen [EXTRACTED 1.00]
- **CBR competentie scoring system (static taxonomy + computed scores + radar visualization)** — voortgang_provider_CbrCompetentie, voortgang_screen_CompetentieScore, voortgang_screen_RadarChartPainter, voortgang_trends_provider_VoortgangTrendsCalculator [INFERRED 0.85]
- **Pakket snapshot pattern vs legacy catalog fallback resolution** — leerling_profiel_LeerlingProfiel, instructor_lesson_package_InstructorLessonPackage, lespakket_detail_LespakketDetail, leerling_profiel_pakket_snapshot_rationale [EXTRACTED 1.00]
...
- **Leerling koppelcode onboarding & account-linking flow** — m0521_generate_koppel_code_fn, m0521_koppel_leerling_met_code_fn, student_profile_gate_studentprofilegate [INFERRED 0.80]
- **Detailheader + navbar shell regressie-hersteltraject** — main_detail_header_test_dart, navbar_background_test_dart, premium_bottom_nav_bar_test_dart, main_scaffold_extendbody_pattern, premium_bottom_nav_bar_widget, rijschool_planner_flutter_instructeur_app [INFERRED 0.85]
- **Profiel-tab gefaseerd architectuur-/beveiligingsonderzoek** — profiel_audit_md, profiel_architectuur_md, profiel_fase4_architectuurcontrole_md, profiel_fase5_persoonlijke_gegevens_md, profiel_fase5a_avatar_storage_beveiliging_md [EXTRACTED 0.90]
- **Order-snapshot ontwerp hergebruikt over pakket en voertuig** — pakket_snapshot_pattern, profiel_fase4_architectuurcontrole_md, profiel_architectuur_md, lesson_vehicle_architecture_review_md [INFERRED 0.85]
- **Profiel-tab gefaseerde documentatiereeks** — profiel_fase6_mijn_rijschool, profiel_stap2_beveiliging, profiel_architectuur_doc, profiel_audit_doc, profiel_fase4_architectuurcontrole_doc [EXTRACTED 0.90]
...
Cohesion: 0.13
Nodes (14): AppCard, build, Divider, _FotoKaart, ListView, MainDetailHeader, _PersoonlijkeGegevensBody, ProfielPersoonlijkeGegevensScreen (+6 more)
...
- `LEERLINGEN_UI_REGELS.md` → `PRODUCT.md`  [AMBIGUOUS]
  PRODUCT.md · relation: conceptually_related_to
- `README.md` → `pubspec.yaml`  [AMBIGUOUS]
...
- **What is the exact relationship between `LEERLINGEN_UI_REGELS.md` and `PRODUCT.md`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **What is the exact relationship between `README.md` and `pubspec.yaml`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
